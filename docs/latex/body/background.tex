...
PCA provides a linear method for generating lossy reversibility latent representations, however, its linear nature limits its ability to capture non-linear relationships, thereby restricting its overall expressiveness.
