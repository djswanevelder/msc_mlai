...
\begin{figure}[!t]
    ...
    \caption{A conditional model sampling system,  embedding a dataset, model weights and results into a shared embedding space}
    \label{fig:pipeline}
\end{figure}
