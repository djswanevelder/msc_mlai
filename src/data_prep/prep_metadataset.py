...
if __name__ == "__main__":
    ...
    ARTIFACT_METADATA_CSV = "data/meta_data.csv"    # Output from the run processing script (contains artifact_name, class1-3, loss)
    ENCODED_WEIGHTS_FILE = "data/model_latents.pth" # Input file containing the latent vectors of the models
